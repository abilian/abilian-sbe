...
class TestUsers(TestCase):
  ...
  def test_user(self):
    user = User(first_name=u"John", last_name=u"Test User",
                email=u"test@example.com", password="toto")
    check_editable(user)
  ...
  def test_user_follow(self):
    ...
    user1 = User(id=1, first_name=u"John", last_name=u"Test User 1",
                 email=u"test1@example.com", password="toto")
    user2 = User(id=2, first_name=u"Joe", last_name=u"Test User 2",
                 email=u"test2@example.com", password="toto")
